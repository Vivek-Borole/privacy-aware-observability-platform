...
- proof seeded secrets and PII are absent from the PostgreSQL tail buffer/outbox, Redpanda, ClickHouse, logs, exported traces, screenshots, and release artifacts;
